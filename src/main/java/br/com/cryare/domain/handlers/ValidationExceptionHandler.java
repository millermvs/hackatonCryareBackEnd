...
public class ValidationExceptionHandler {
	 ...
	 * handlerErroInterno(Exception ex) { Map<String, Object> body = new
	 * HashMap<String, Object>(); body.put("datahora", LocalDateTime.now());
	 * body.put("status", HttpStatus.INTERNAL_SERVER_ERROR.value());
	 * body.put("errors", "Erro interno no servidor. Tente novamente mais tarde.");
	 * body.put("fordev", ex.getMessage());
	 * 
	 * return
	 * ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR.value()).body(body); }
	 */
